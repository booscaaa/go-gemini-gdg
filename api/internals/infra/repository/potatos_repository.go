...
const (
	POTATOS_SITE = "https://potatosburger.menudino.com"
)

type potatosRepository struct {
	scrapper *playwright.Playwright
}

// FindProducts implements contract.ProductScraperRepository.
func (repository *potatosRepository) FindProducts(context.Context) ([]domain.Product, error) {
